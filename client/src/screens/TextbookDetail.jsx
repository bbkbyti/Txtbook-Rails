    ...
    return (
        <div className=" lg:font-serif lg:grid lg:grid-cols-3 lg:min-h-screen lg:bg-blue-50 flex flex-col justify-evenly min-h-screen font-serif">
            <div className="lg:mt-20 flex justify-center">
                <img className='w-7/12'
                    src={textbook.img_url}
                    alt={textbook.title}
                />
                </div>
                
                    <div className=" lg:flex lg:flex-col lg:justify-center lg:pr-40 lg:text-2xl lg:font-bold lg:mb-32 flex flex-col px-7">
                    ...
                    <div className="lg:flex lg:flex-col lg:justify-center lg:mb-44 flex justify-evenly">
