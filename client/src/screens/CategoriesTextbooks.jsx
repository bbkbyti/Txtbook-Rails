...
export default function CategoriesTextbooks(props) {
  ...
  return (
    <div className="lg:min-h-screen lg:font-bold lg:font-serif min-h-screen font-bold font-serif">
      <div className="lg:flex lg:flex-crow lg:justify-center lg:text-black">
            ...
            <div>
                ...
                {category.textbooks?.map(textbook => (
                  <Link to={`/textbooks/${textbook.id}`}>
                    <img className='lg:shadow-2xl lg:w-5/12 lg:ml-32 lg:rounded-2xl lg:my-3 lg:flex lg:justify-center lg:items-center shadow-2xl rounded-3xl w-6/12 ml-24 mt-7' src={textbook.img_url} alt={textbook.title} />
